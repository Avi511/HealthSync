          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="col-span-12 min-[1031px]:col-span-6 space-y-6 sm:space-y-8 flex flex-col justify-center items-center min-[1031px]:items-start text-center min-[1031px]:text-left order-2 lg:order-1">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center min-[1031px]:justify-start gap-4 w-full sm:w-auto">
                <Link
                  to="/book-appointment"
                  className="group flex items-center justify-center space-x-2 text-sm font-semibold text-white bg-primary hover:bg-primary-dark transition-all duration-200 px-8 py-4 rounded-full shadow-lg shadow-primary/20 hover:shadow-xl hover:shadow-primary/30 transform hover:-translate-y-0.5 text-center"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            <div className="lg:col-span-7 space-y-6 order-2 lg:order-1">
              <div className="group flex flex-col sm:flex-row gap-5 p-6 sm:p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md hover:border-primary/20 transition-all duration-300 transform hover:-translate-y-1">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            <div className="lg:col-span-5 space-y-6">
              <div className="flex gap-4 p-6 bg-gray-50/50 border border-gray-100 rounded-3xl hover:border-primary/20 transition-all duration-300">
              ...
              {submitted ? (
                <div className="text-center py-12 space-y-6 animate-[fadeIn_0.5s_ease-out]">
                  ...
                  <button
                    ...
                    className="inline-flex items-center text-sm font-semibold text-primary hover:text-primary-dark transition-colors duration-200 mt-4 focus:outline-none"
                  >
